...
def process():
	...
	statements_tokenized = tokenize(statements)
	statements_stemmed = stem_all(statements_tokenized)
	dictionary = create_dictionary(statements_stemmed)
	statements_vectorized = vectorize_statements(statements_stemmed, dictionary)
